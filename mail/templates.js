export const REGISTRATION_TEMPLATES = {
  subject: (projectName) => `Welcome to ${projectName} - Registration OTP`,
  text: (Username, projectName, otp) =>
    `Hello ${Username},\n\n` +
  ...
  html: (Username, projectName, otp) => `<html>
